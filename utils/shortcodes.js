...
module.exports = {
   ...
   *  /src/_includes/components/nav.njk (for the logos)
	...
	video: function (url, vtitle, vratio) {
		const slug = url ? url : 'https://www.youtube.com/embed/oHg5SJYRHA0'
		const title = vtitle ? vtitle : 'Video'
		return `<div id="${title}" style="position:relative; width:100%; "><iframe style="position:absolute; top:0; right:0; bottom:0; left:0; width:100%; height:100%" width="100%" height="100%" title="${title}" src="${slug}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen loading="lazy"></iframe></div>`
	},
}
